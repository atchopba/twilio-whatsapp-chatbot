...
def step_response(incoming_msg: str) -> str:
    global current_step, user_responses, previous_step_str, is_last_dialog, list_files, is_global_question
...
def step_in_courtesy(response_msg: str) -> str:
    global current_step, user_responses, list_files, is_change_folder, is_global_question, nb_folder_question, propose_all_questions_folder
    ...
    if COURTESY_STR not in next_file and not is_change_folder:
        ...
        folder_question = folder_.check_probability_and_return_folder(response_msg)
